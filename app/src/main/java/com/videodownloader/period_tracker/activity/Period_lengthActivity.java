...
import com.videodownloader.period_tracker.databinding.ActivityPeriodLengthBinding;
...
public class Period_lengthActivity extends AppCompatActivity implements View.OnClickListener {
        ActivityPeriodLengthBinding binding;
    View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityPeriodLengthBinding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_started:
                updateData(view);
             //   startActivity(new Intent(Period_lengthActivity.this,Last_Period_StartActivity.class));
        }
    }
